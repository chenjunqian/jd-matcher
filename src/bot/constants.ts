...
export const RESUME_TYPE_ERR = "Please upload your resume in text or PDF format.";
...
export const EMAIL_PROMPT = "Please enter your email address.";
export const EMAIL_FORMAT_ERR = "Invalid email format. Please enter a valid email address.";
export const EMAIL_SENT = "Verification email sent to %s. Please click the link in the email to verify.";
export const EMAIL_VERIFIED = "Your email %s has been verified successfully!";
export const EMAIL_ALREADY_VERIFIED = "This verification link has already been used.";
export const EMAIL_EXPIRED = "This verification link has expired. Please use /email again.";
export const EMAIL_LOGIN_HINT = "You are not registered. Please use /start first.";
export const EMAIL_UPDATE_HINT = "Your current email is %s. A verification email will be sent to %s to update it.";
