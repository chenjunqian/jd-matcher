...
func allJobsCallbackHandler(ctx context.Context, b *bot.Bot, update *models.Update) {
	allJobsCallback(ctx, b, update)
}

func allJobsCallback(ctx context.Context, b *bot.Bot, update *models.Update)  {
